...
const FeaturesSection = () => {
  return (
    <>
      <div id="features" className="my-20 mx-auto flex flex-col gap-y-10 container max-w-[1200px] px-4">
        <div className="flex flex-col gap-y-4 items-center ">
          <p className=" text-2xl lg:text-3xl font-semibold lg:font-bold text-black">
            Features
          </p>
          <div className="w-20 h-0.5 rounded-full bg-[#CF2722]"></div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 gap-y-10 justify-center">
